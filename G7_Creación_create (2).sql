...
-- Last modification date: 2019-06-01 20:55:07.464
...
CREATE TABLE GR7_ALQUILER (
    ...
    CONSTRAINT PK_GR7_ALQUILER PRIMARY KEY (id_alquiler,cuit_cuil)
);
...
CREATE TABLE GR7_MOV_ENTRADA (
    ...
    nro_fila int  NOT NULL,
    id_alquiler serial  NOT NULL,
    CONSTRAINT PK_GR7_MOV_ENTRADA PRIMARY KEY (id_movimiento,cod_pallet,id_alquiler)
);
...
ALTER TABLE GR7_ALQUILER_POSICIONES ADD CONSTRAINT FK_GR7_ALQUILER_POSICIONES_ALQUILER
    FOREIGN KEY (id_alquiler, cuit_cuil)
    REFERENCES GR7_ALQUILER (id_alquiler, cuit_cuil)
    NOT DEFERRABLE
    INITIALLY IMMEDIATE
;
...
ALTER TABLE GR7_MOV_INTERNO ADD CONSTRAINT FK_GR7_MOV_INTERNO_MOV_ENTRADA
    FOREIGN KEY (id_movimiento_entrada, cod_pallet, id_alquiler)
    REFERENCES GR7_MOV_ENTRADA (id_movimiento, cod_pallet, id_alquiler)
    NOT DEFERRABLE
    INITIALLY IMMEDIATE
;
